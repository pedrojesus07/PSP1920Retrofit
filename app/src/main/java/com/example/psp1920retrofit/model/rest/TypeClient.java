package com.example.psp1920retrofit.model.rest;

import com.example.psp1920retrofit.model.data.Pokemon;
...
public interface TypeClient {
    ...
    @GET("pokemon/{id}")
    Call<Type> getPokemon(@Path("id") long id);

    @GET("pokemon")
    Call<ArrayList<Type>> getPokemons();
